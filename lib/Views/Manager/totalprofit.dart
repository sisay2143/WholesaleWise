              ...
              children: [
                                    ...
                                    builder: (context, salesSnapshot) {
                                      ...
                                      if (salesSnapshot.hasData &&
                                        ...
                                        for (var productDoc in productDocs) {
                                          final productName = (productDoc.data()
                                                  as Map<String, dynamic>)[
                                              'name'] as String?;
                                          final productPrice =
                                              (productDoc.data() as Map<String,
                                                  dynamic>)['price'] as num?;
                                          if (productName != null &&
                                              productPrice != null) {
                                            itemProfits[productName] =
                                                0.0; // Initialize profit for each product
                                          }
                                        }

                                        // Iterate through sales transactions to calculate profits
                                        for (var saleDoc in salesDocs) {
                                          final productName = (saleDoc.data()
                                                  as Map<String, dynamic>)[
                                              'productName'] as String?;
                                          final sellingPrice = double.tryParse(
                                                  (saleDoc.data() as Map<String,
                                                                  dynamic>)[
                                                              'sellingPrice']
                                                          as String? ??
                                                      '') ??
                                              0.0;
                                          final saleQuantity = (saleDoc.data()
                                                  as Map<String, dynamic>)[
                                              'quantity'] as num?;
                                          if (productName != null &&
                                              itemProfits
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        title: Text('Total Profit Generated from Product Sales by Date (in birr)'),
                      ),
                      Container(
                        height: 220,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Text(
                                                  '${int.parse(documents[i]['sellingPrice'].toString()) * int.parse(documents[i]['quantity'].toString())}'),
                                            ),
                                            Expanded(
                                              child: FutureBuilder(
                                                future: FirebaseFirestore
                                                ...
                                                builder: (BuildContext context,
                                                  ...
                                                  final purchased =
                                                      double.parse(snapshot
                                                          ...
                                                          .docs[0]['price']
                                                          .toString());
                                                  final soldAt = double.parse(
                                                      documents[i]
                                                              ['sellingPrice']
                                                          .toString());
                                                  final quantitySold =
                                                      int.parse(documents[i]
                                                              ['quantity']
                                                          .toString());
                                                  final profit =
                                                      (soldAt - purchased) *
